 ...
 */
public class RegularReactionCopy
        implements Instantiable, Copyable, Settable, Reaction
{
     ...
     */
    public RegularReactionCopy(Node xmlNode, Settable parent)
    {
...
//	}
    ...
    public void instantiate(Element xmlElem, Settable parent)
    {
        ...
        this._stoichiometry.instantiate( xmlElem, this,
                String.class.getSimpleName(), Expression.class.getSimpleName(),
    ...
    public Object copy()
    {
        ...
        return new RegularReactionCopy(stoichiometry, this._kinetic, this._name);
    }
    ...
    private double getStoichiometry(String reactantName)
    {
        if ( this._stoichiometry.containsKey(reactantName) )
            return this._stoichiometry.get(reactantName).getValue(); //FIXME pass it the agents aspects!!!
        return 0.0;
    }
