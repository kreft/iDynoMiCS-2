...
//
//    private int _nDim = _shape.getNumberOfDimensions();
//    /**
//     * The svg exporter
//     */
...
//
//    /* raster sizes including margins and actual size */
//    private int rX, rY;
//    /* raster sizes and vector length in last field */
//    private int[] r;
//    private int[] size;
//
...
//     */
//    public Raster3D(AgentContainer agentContainer)
//    {
...
//     * @param compartment associated with this raster
//     */
//    public Raster3D(AgentContainer agentContainer, boolean verbose)
//    {
//        this._agentContainer = agentContainer;
//        this._shape = agentContainer.getShape();
//        this.r = new int[_nDim+1];
//        this.max_value = Vector.vector(_nDim, Integer.MAX_VALUE);
//        this.zeros = Vector.vector(_nDim, 0);
//
...
//     */
//    public Raster3D(Compartment compartment, boolean verbose)
//    {
...
//        }
//
//        /* matrix dimension length is +1 for non periodic */
//        for( int i = 0; i < _nDim; i++)
//            r[i] = ( _periodic[i] ? size[i] : size[i] + 1 );
//
//        HyperCube<Integer> agents = new HyperCube<Integer>(Integer.MAX_VALUE, r);
//
////        int[][][] agents = new int[rX][rY][2];
////        Array.setAll(agents, Integer.MAX_VALUE);
//
//        /* fill matrix, add spacers for non periodic. */
//        agents = this.fillPresenceMap( this.agentMap(), agents, _periodic,false);
...
//    }
//
//    public HyperCube<Integer> fillPresenceMap( SpatialMap<Integer> agentMap,
//            HyperCube<Integer> cube, boolean[] periodic, boolean inverse) {
//
//        int temp;
//        /* fill matrix, add spacers for non periodic. */
...
//
//            if( this._nDim > 2)
//                cube.setAll( temp,  ( periodic[0] ? key[0] : key[0] + 1 ) ,
//                        ( periodic[1] ? key[1] : key[1] + 1 ) ,
//                        ( periodic[2] ? key[2] : key[2] + 1 ) );
//            else
//                cube.setAll( temp,  ( periodic[0] ? key[0] : key[0] + 1 ) ,
//                        ( periodic[1] ? key[1] : key[1] + 1 ) );
//        }
