 ...
 * @param <A>
 */
public class AreColliding<A> implements Predicate<Collection<Surface>>
{
	private Collection<Surface> _surfaces;
	private Collision _collision;
	private double _margin = 0.0;
	
	public AreColliding(Surface surf, Collision collision)
	{
	...
	public AreColliding(Surface surf, Collision collision, double margin)
	{
		this(surf, collision);
		this._margin = margin;
	}
	
	public AreColliding(Collection<Surface> surfaces, Collision collision)
	{
		this._surfaces = surfaces;
		this._collision = collision;
	}
	
	public AreColliding(Collection<Surface> surfaces, 
