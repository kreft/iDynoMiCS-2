...
import reaction.simple.ReactionParameter;
import reaction.simple.ReactionRate;
import reaction.simple.ReactionRate.ode;
...
public class reactionTest {
	...
	public void testReaction()
	{
		...
		System.out.println("Michaelis Menten: lambert W function, heun's,"
				+ " euler's method");
		Reaction m = new Reaction(1.0, new MichaelisMenten(0.2, 0.05));
		...
		Reaction AMXgrowth = new Reaction(new double[]{-1.0,1.0,1.0,0.0}, 
				new Combined( new ReactionRate[]{ new ReactionParameter(), 
