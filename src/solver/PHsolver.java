...
public class PHsolver {
    ...
    public void solve(Collection<SpatialGrid> solutes) {
    ...
    public NonlinearEquationSolver chemTestnoLin ( int numberOfVariables, int solver, boolean analyticalJacobian){
